...
void HTFT_voidPrintChar(s8 copy_s8Char , u16 copy_u16X , u16 copy_u16Y, u8 copy_u8Size , u16 copy_u16Color , u16 copy_u16BackColor)
{
	...
	for (u8 i = TFT_CHARACTER_WIDTH; i >0 ; i-- )
	{
		for (u8 j = TFT_CHARACTER_HIGHT ; j > 0 ; j--)
		{
...
static void TFT_voidSetAddress (u16 copy_u16StartX ,u16 copy_u16EndX , u16 copy_u16StartY , u16 copy_u16EndY)
{
...
static void TFT_voidSetColour(u16 copy_u16Colour)
{
	/* Write pixel */
...
static void TFT_voidDrawPixel (u16 copy_u16X , u16 copy_u16Y , u16 copy_u16Colour)
{
